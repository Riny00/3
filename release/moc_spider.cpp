...
void spider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (spider::*_t)(QVector<QString> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&spider::sendtomain)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject spider::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_spider.data,
